 ...
 */
public class HandShakePacket extends MysqlPacket<HandShakeMessage> {

    private Logger logger = LoggerFactory.getLogger(HandShakePacket.class);
    ...
    HandShakeMessage decodeBody0() {
        ...
        try {
            ...
            HandShakeMessage handShakeMessage = new HandShakeMessage(serverCapabilities, pluginName, ByteBufUtil.getBytes(seed));
